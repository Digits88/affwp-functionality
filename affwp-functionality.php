...
add_action( 'plugins_loaded', function() {
    ...
    add_action( 'monsterinsights_tracking_before', 'affwpcf_monsterinsights_performance_frontend_tracking_options_before_analytics' );
}, 1000);

function affwpcf_monsterinsights_performance_frontend_tracking_options_before_analytics() {
    ob_start();
